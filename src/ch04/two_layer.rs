use std::{
    cell::RefCell, collections::HashMap, rc::Rc, sync::RwLockWriteGuard,
    time::TryFromFloatSecsError,
};

use ndarray::{Array, Array1, Array2, Array3, AsArray, Axis, Dimension, Ix1, Ix2, Zip};
use ndarray_rand::{
    RandomExt,
...
fn sdf(x: Array2<Element>, y: Array2<Element>) {
    let z = x + y;
}
